...
LIBS += post/e2prom/libe2prom.a post/libpost.a post/cpu/libcpu.a
LIBS += common/libcommon.a
LIBS += drivers/hisilicon/libdrv.a
.PHONY : $(LIBS)
...
include $(shell for hiboardmk in hisilicon_board*.mk ; do echo $(TOPDIR)/$$hiboardmk;done )
#include hisilicon_board*.mk
hiconfig:	unconfig
	@./hiconfig 
...
clobber:	clean
	...
	rm -fr *.*~
	rm -f u-boot u-boot.map u-boot.hex $(ALL) hisiex-*
